...
exports.js_beautify=js_beautify;if(!arguments[0]||!arguments[1]){print('No input received');}
else{var options={'space_after_anon_function':true};prefs=arguments[1].split(',');for(var i=0;i<prefs.length;i++){if(prefs[i]!=''){if(prefs[i]=='indent_char_space'){options['indent_char']=' ';options['indent_size']=4;}
