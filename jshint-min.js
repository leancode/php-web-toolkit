...
exports.JSHINT=JSHINT;var JSHINTWRAP=function(input){var prefs=['bitwise','browser','cap','css','debug','devel','eqeqeq','fragment','immed','newcap','on'];var options={'predef':['window','self']};for(var i=0;i<prefs.length;i++){options[prefs[i]]=true;}
