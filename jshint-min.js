...
if(nexttoken.id!==','){break;}
comma();}
return this;};stmt('var',varstatement).exps=true;blockstmt('function',function(){if(inblock){warning("Function statements should not be placed in blocks. Use a function expression or move the statement to the top of the outer function.",token);}
...
var itself=function(s,o){var a,i,k;JSHINT.errors=[];predefined=Object.create(standard);if(o){a=o.predef;if(a){if(Array.isArray(a)){for(i=0;i<a.length;i+=1){predefined[a[i]]=true;}}else if(typeof a==='object'){k=Object.keys(a);for(i=0;i<k.length;i+=1){predefined[k[i]]=!!a[k];}}}
...
o.push(m+'<br>*/</pre>');}
o.push('</div>');}}
return o.join('');};itself.jshint=itself;itself.edition='2011-02-19';return itself;}());if(typeof exports=='object'&&exports)
exports.JSHINT=JSHINT;var JSHINTWRAP=function(input){var prefs=['bitwise','browser','cap','css','debug','devel','eqeqeq','fragment','immed','newcap','nomen','on'];var options={'predef':['window','self']};for(var i=0;i<prefs.length;i++){options[prefs[i]]=true;}
...
print("<html><head><style type='text/css'>body{font-size:13px;font-family:sans-serif;} h2{font-family:sans-serif;font-size:18px;} h2.warning{color: blue; } h2.error{color: red; } p{margin-bottom: 0; } p.evidence,pre,code {background: #f5f5f5; border: 1px solid #ccc; font-size: 13px; margin-top: 2px; padding: 2px 4px; }</style></head><body>");print(err_desc+"\n");print(report);};if(!arguments[0]){print('No input received...');}
