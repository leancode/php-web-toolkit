...
//$GLOBALS['csstidy']['shorthands']['-moz-linear-gradient'] = array('1', '2', '3');
...
$GLOBALS['csstidy']['predefined_templates']['default'][] = "\t".'<span class="property">'; //string before property !!@mf coda plugin
...
$GLOBALS['csstidy']['predefined_templates']['high_compression'][] = '</span><span class="format">{</span>';
$GLOBALS['csstidy']['predefined_templates']['high_compression'][] = '<span class="property">'; //string before property
$GLOBALS['csstidy']['predefined_templates']['high_compression'][] = '</span><span class="value">'; //string after property+before value
$GLOBALS['csstidy']['predefined_templates']['high_compression'][] = '</span><span class="format">;</span> '; //string after value
$GLOBALS['csstidy']['predefined_templates']['high_compression'][] = '<span class="format">}</span>'; //closing bracket - selector
...
/* view also https://github.com/Cerdic/CSSTidy */
